...
#import "KBConfigForPhoneController.h"

@interface KBConfigForPhoneController ()
@property (weak, nonatomic) IBOutlet UITextField *phoneNum;

@end

@implementation KBConfigForPhoneController
...
- (IBAction)dealCommit:(id)sender {
        ...
        [KBHelper KBPOST:URL_GET_USERINFO parameters:parameter progress:^(NSProgress * _Nonnull uploadProgress) {
            ...
            if(nil != self.phoneNum.text){
                userInfo.telephone = self.phoneNum.text;
                userInfo.pwd = nil;
